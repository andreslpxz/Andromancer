...
class AsyncLLMClient:
    ...
    async def complete_chat(self, system_prompt: str, user_prompt: str, model: str = None, image_path: str = None, timeout: float = 30.0) -> dict:
        if not self.api_key:
    ...
    async def complete_text(self, system_prompt: str, user_prompt: str, model: str = None, timeout: float = 30.0) -> str:
